...
namespace GYMappWeb.Migrations
{
    ...
    [Migration("20251003183732_loggs")]
    partial class loggs
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GYMappWeb.Areas.Identity.Data.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("GYMappWeb.Models.Checkin", b =>
                {
            ...
            modelBuilder.Entity("GYMappWeb.Models.GymBranch", b =>
                {
                    b.Property<int>("GymBranchId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("GymBranchId"));
                    ...
                    b.HasKey("GymBranchId")
                        .HasName("PK_GymBranches");

                    b.ToTable("GymBranches", (string)null);
                });

            modelBuilder.Entity("GYMappWeb.Models.LogEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GYMappWeb.Areas.Identity.Data.ApplicationUser", b =>
                {
                    b.HasOne("GYMappWeb.Models.GymBranch", null)
            ...
            modelBuilder.Entity("GYMappWeb.Models.Checkin", b =>
                {
                    b.HasOne("GYMappWeb.Models.GymBranch", "GymBranch")
                        .WithMany("Checkins")
                        .HasForeignKey("GymBranchId")
                        .IsRequired()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("GYMappWeb.Areas.Identity.Data.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("GYMappWeb.Models.GymBranch", b =>
                {
                    ...
                    b.Navigation("MembershipFreezes");
